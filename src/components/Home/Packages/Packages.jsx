            ...
            <div key={card.id} className="">
              <div className="relative group">
                ...
                <div className="absolute inset-0 flex  items-end opacity-0 group-hover:opacity-50 group-hover:bg-black rounded-md transition duration-1000 ease-in-out">
                  <div className="text-white text-sm lg:text-lg font-semibold p-3">
              ...
              <div className="p-4 border rounded-b-md">
                ...
                <div className="flex gap-2">
                  <p className="font-semibold text-sm lg:text-lg mb-1 text-gray-700">
                    Address :
                  </p>{" "}
                ...
                <div className="flex justify-between items-center mt-2">
                  <div className="flex gap-2">
                    <p className="font-bold text-sm lg:text-lg mb-1 text-gray-700">
                      Booking :
                    </p>{" "}
                    <p className="font-bold text-sm lg:text-lg mb-1 text-gray-500">
                      {card.price}
                    </p>
                  </div>
                  <Link to={`/single-package/${card.id}`}>
                    <div className="w-6 h-6 md:w-8 md:h-8 bg-sky-100 rounded-full border border-blue-950 flex items-center justify-center">
